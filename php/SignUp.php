...
<head>
    ...
    <script type="text/javascript" src="../js/showComprobar.js"></script>
    <script type="text/javascript" src="../js/showComprobarPass.js"></script>
</head>
<body>
  ...
  <section class="main" id="s1">
      ...
      <div>
       <form action="SignUp.php" name="fregister" id="fregister" method="post" enctype="multipart/form-data">
        ...
        <input type="email" size="60" id="dirCorreo" name="dirCorreo" required onblur="seeResultComprobar()">
        <div id="comprobarResultado" name="comprobarResultado"></div>
        <p>Introduce tu nombre y apellido(s) *</p>
        <input type="text" size="60" id="nombreApellidos" name="nombreApellidos" required>
        <p>Contraseña: *</p>
        <input type="password" size="60" id="pass" name="pass" required onblur="seeResultComprobarPass()">
        <div id="comprobarResultadoPass" name="comprobarResultadoPass"></div>
...
<div>
    ...
    if(isset($_REQUEST['dirCorreo'])){
        ...
        echo '<br>La contraseña es';
        include 'ClientVerifyPass.php';


        if($result=="SI" && $resultpass=="VALIDA"){
